            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                GuideSection(
                    ...
                    steps: [
                        ...
                        "Change or Add on a day opens Wardrobe to pick an item for that slot, then returns to that day. Picking a wardrobe item pins it; generating fills only the remaining slots.",
                        "Planning templates store prefs and pins (no full outfits). Plan history keeps past weekly outfits — both stay collapsed until you expand them.",
                        "New plan saves a copy under Plan history. Day cards show Needs outfit / Not planned only when exceptional — not Ready on every day."
                    ],
                    tip: isAdmin
