...
class OutfitService:
    ...
    def save_outfit_history(
        ...
        optional_history_fields = {
            ...
            "sweater_id": getattr(suggestion, "sweater_id", None),
            "outerwear_id": getattr(suggestion, "outerwear_id", None),
            "tie_id": getattr(suggestion, "tie_id", None),
