"""
Migration script to add optional outfit layer columns to outfit_history table.
"""
...
def migrate_database() -> None:
    ...
    try:
        with engine.connect() as conn:
            ...
            conn.commit()
            print("✅ outfit_history optional layer columns migration completed")
