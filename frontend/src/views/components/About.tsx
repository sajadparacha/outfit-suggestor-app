                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-300">
                      ...
                      Use the week overview to pick a day, open its detail panel for items and missing-item actions, then Save weekly plan. Toggle Use wardrobe per day, and load a previous plan from history when you want an earlier week back. Daily wake-up reminders are iOS-first (local notifications); on the web, Today stays in-app.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
