  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="rounded-2xl bg-white/5 border border-white/10 shadow-xl overflow-hidden backdrop-blur">
        {/* Header Section */}
        <div className="bg-gradient-to-r from-teal-500/30 to-indigo-500/30 border-b border-white/10 px-8 py-12 text-center">
          <div className="mb-4">
        ...
        <div className="px-8 py-8">
          ...
          {/* About the App */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-white mb-4">About This App</h3>
            <p className="text-slate-200 leading-relaxed mb-4">
              ...
              Upload a photo of <strong className="text-white">any clothing item</strong> - whether it's a shirt, blazer, footwear, 
          ...
          <div className="mb-8">
            ...
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-slate-200 mb-4 pb-2 border-b border-white/10">👔 Wardrobe Management</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Edit Wardrobe Items</h4>
                    <p className="text-sm text-slate-300">Update category, color, description, and images for any wardrobe item. All changes are saved instantly, keeping your wardrobe up-to-date and accurate.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🤖</span>
                  <div>
                    <h4 className="font-semibold text-white">AI-Powered Item Analysis</h4>
                    <p className="text-sm text-slate-300">Add items to your wardrobe with automatic AI analysis using BLIP or ViT-GPT2 models. The AI extracts category, color, and description from your photos, ready for you to review and edit.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">✨</span>
                ...
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🔍</span>
                  <div>
                    <h4 className="font-semibold text-white">Intelligent Duplicate Detection</h4>
                    <p className="text-sm text-slate-300">Advanced perceptual hashing prevents duplicate wardrobe items and outfit suggestions, saving time and API costs while keeping your wardrobe organized.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🔍</span>
                  <div>
                    <h4 className="font-semibold text-white">Image Viewer</h4>
                    <p className="text-sm text-slate-300">Click on any wardrobe item image to view it in full-screen mode. Perfect for inspecting details and getting a better look at your clothing items.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-slate-200 mb-4 pb-2 border-b border-white/10">🎯 Outfit Suggestions</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🎯</span>
                  <div>
                    <h4 className="font-semibold text-white">Flexible Input Support</h4>
                    <p className="text-sm text-slate-300">Upload any clothing item - shirts, blazers, footwear, or even partial outfit combinations. The AI adapts to what you provide.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🧩</span>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-300">Choose &quot;Use my wardrobe only&quot; to get suggestions exclusively from items in your wardrobe, or &quot;Free generation&quot; to let AI suggest any outfit. Toggle in the sidebar when logged in.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🎲</span>
                  <div>
                    <h4 className="font-semibold text-white">Random Picks</h4>
                    <p className="text-sm text-slate-300">When logged in, use <strong>Random from Wardrobe</strong> to get an AI-built outfit from your wardrobe, or <strong>Random from History</strong> to see a random past suggestion for quick inspiration.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-slate-200 mb-4 pb-2 border-b border-white/10">🖼️ AI & Visualization</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🖼️</span>
                  <div>
                    <h4 className="font-semibold text-white">AI Model Visualization</h4>
                ...
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🌍</span>
                  <div>
                    <h4 className="font-semibold text-white">Location-Based Customization</h4>
                    <p className="text-sm text-slate-300">Model images are customized based on your geographical location for culturally appropriate and relatable appearances.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🎛️</span>
                  <div>
                    <h4 className="font-semibold text-white">Multiple AI Models</h4>
                    <p className="text-sm text-slate-300">Choose between DALL-E 3 and Stable Diffusion for model image generation, and BLIP or ViT-GPT2 for wardrobe item analysis - each optimized for different use cases.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">📷</span>
                  <div>
                    <h4 className="font-semibold text-white">Smart Image Optimization</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-300">Track all your past suggestions with searchable history, including generated model images for easy reference and inspiration. Search by clothing items, colors, or context.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🗑️</span>
                  <div>
                    <h4 className="font-semibold text-white">Manage History</h4>
                    <p className="text-sm text-slate-300">Delete individual outfit history entries you no longer need. Keep your history clean and organized with simple deletion controls.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🔍</span>
                  <div>
                    <h4 className="font-semibold text-white">Full-Screen Image Viewing</h4>
                    <p className="text-sm text-slate-300">Click on any outfit history image (uploaded photos or AI-generated model images) to view them in full-screen mode for better detail inspection.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-slate-200 mb-4 pb-2 border-b border-white/10">🔐 User Experience</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">🔐</span>
                  <div>
                    <h4 className="font-semibold text-white">Secure User Accounts</h4>
                    <p className="text-sm text-slate-300">Create an account to save your wardrobe, outfit history, and preferences. Your data is securely stored and private.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">📱</span>
                  <div>
                    <h4 className="font-semibold text-white">Multi-Platform Support</h4>
                    <p className="text-sm text-slate-300">Web and iOS apps available, with seamless synchronization of your wardrobe and outfit history across devices.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <span className="text-2xl">📱</span>
                  <div>
                    ...
                    <p className="text-sm text-slate-300">Responsive layout with scrollable navigation on small screens, touch-friendly buttons (48px targets), and optimized padding. Use the app comfortably on phones and tablets.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-white/10 pt-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 px-6 py-3 bg-gradient-to-r from-teal-500/30 to-indigo-500/30 text-white rounded-full hover:from-teal-500/50 hover:to-indigo-500/50 border border-white/15 transition-colors w-full sm:w-auto justify-center"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-white/10 pt-8 mt-8">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <span className="px-4 py-2 bg-white/10 text-teal-200 rounded-full text-sm font-medium border border-white/15">
                React
              </span>
              <span className="px-4 py-2 bg-white/10 text-teal-200 rounded-full text-sm font-medium border border-white/15">
                TypeScript
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        {/* Project Card */}
        <div className="rounded-2xl bg-white/5 border border-white/10 p-6 text-center backdrop-blur">
