        ...
        >
          <StepList
            items={[
              ...
              'New plan asks for confirmation, then clears the current week (a snapshot is kept under Plan history).',
              'Under Plan history (collapsed by default), tap Load to restore an earlier week as your current plan.',
              'Planning templates (prefs and pins): use Save as… to store your week setup and pinned wardrobe items; Load applies them and clears outfits—tap Generate outfits when ready. Templates do not store full outfits.',
